...
// راهنمای تقریبیِ تبدیلِ طولِ کف‌پا (سانتی‌متر) به سایزِ اروپاییِ کفش.
// این یک استانداردِ عمومیِ صنعت است؛ سایزِ دقیق می‌تواند بینِ برندها ۰.۵ تا ۱ نمره فرق کند.
export const footCmToEuShoeSize: [number, number][] = [
  [21.5, 34], [22, 35], [22.5, 35.5], [23, 36], [23.5, 37],
  [24, 37.5], [24.5, 38], [25, 39], [25.5, 40], [26, 40.5],
  [26.5, 41], [27, 42], [27.5, 42.5], [28, 43], [28.5, 44],
  [29, 44.5], [29.5, 45], [30, 46],
];
